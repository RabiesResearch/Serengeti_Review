...
<b>Quarter 1</b>  
  ...
  * Animal Rabies cases - `r embed_review(type="case", quarter_n=quarter_n, label="Download")`  
  * Human Rabies exposures - `r embed_review(type="exposure", quarter_n=quarter_n, label="Download")`  